...
namespace AppAdvisory.MathGame
{
    public class GameManager : Manager<GameManager>
    {
        ...
        void PlaySoundFalse()
        {
            GetComponent<AudioSource>().PlayOneShot(falsedAnswerSound, oneShotVolume);
        }

        //play fx when answer is good
        void PlaySoundGood()
        {
            GetComponent<AudioSource>().PlayOneShot(goodAnswerSound, oneShotVolume);
        }
        ...
        public void ShowEffect(float volume)
        {
            GetComponent<AudioSource>().PlayOneShot(falsedAnswerSound, volume);
        }

        public void ChangeSoundEffectAudio(float volume)
        {
